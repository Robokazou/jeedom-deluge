...
Ce plugin ce base sur un plugin dans deluge pour fonctionner. Il faut donc que ce dernier soit correctement install
https://github.com/idlesign/deluge-webapi#installation
L'installation est très simple si vous avez deja le WebUI. Sinon Commencé par installer le WebUI.

Aussi, penser à bien activer le plugin.

![blabla](img/ActivePlugin.png)
